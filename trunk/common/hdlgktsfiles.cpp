...
int HDlgKTSFiles::CreateStatusBar (CWnd *pParent) {
	...
	for (HDlgKTSFiles::ID_INDICATORS id = HDlgKTSFiles::ID_INDICATOR_TEMPLATE; id < HDlgKTSFiles::COUNT_INDICATORS; id++) { m_arIdIndicators[id] = WM_USER + 967 + id; }
	//for (HDlgKTSFiles::ID_INDICATORS id = HDlgKTSFiles::ID_INDICATOR_TEMPLATE; id < HDlgKTSFiles::COUNT_INDICATORS;  id = static_cast<ID_INDICATORS>(static_cast<int>(id) + 1)) { m_arIdIndicators [id] = WM_USER + 967 + id; }
